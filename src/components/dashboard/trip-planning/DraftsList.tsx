...
const DraftsList: React.FC<DraftsListProps> = ({ hook }) => {
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm h-full">
            ...
            >
              <div>
                ...
                <p className="text-xs text-gray-500">
                  De {draft.lieuDepart} à {draft.lieuArrive}
                </p>
              </div>
              <div className="flex items-center gap-2">
                <button
                  onClick={() => handleSelectDraft(draft.idVoyage)}
                ...
                <button
                  onClick={() => handlePublishDraft(draft.idVoyage)}
      ...
      <button
        onClick={() => handleSelectDraft(null)}
        className="mt-4 w-full flex items-center justify-center gap-2 rounded-md border border-dashed border-gray-300 py-2 text-sm font-medium text-gray-600 hover:bg-gray-100"
      >
