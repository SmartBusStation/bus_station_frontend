// src/components/dashboard/resources/AddDriverModal.tsx
        ...
        >
          <div className="p-6 space-y-4">
            ...
            <h3 className="text-md font-medium text-gray-800">
              Informations du permis (Optionnel pour l'instant)
            </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <InputField
                ...
                register={register("numeroPermis")}
              ...
              <InputField
                ...
                register={register("dateExpirationPermis")}
                error={errors.dateExpirationPermis?.message}
              />
            </div>
          </div>
