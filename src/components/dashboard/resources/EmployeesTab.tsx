...
import { Plus, Edit, Trash2, Users, AlertCircle, Search, Mail, Building2 } from "lucide-react"
...
const EmployeesTab = () => {
    ...
    const getPosteBadge = (poste: string) => {
        const badges = {
            ...
            "Réceptionniste": { color: "bg-purple-100 text-purple-800", icon: "📞" },
                ...
                <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                    <table className="min-w-full">
                        ...
                        {filteredEmployees.map((employee, index) => {
                            ...
                            return (
                                <tr key={employee.employeId} className={`${index % 2 === 0 ? 'bg-white' : 'bg-gray-50/30'} hover:bg-blue-50/50 transition-colors`}>
                                    {/* Employé */}
                                    ...
                                    {/* Poste */}
                                    <td className="px-8 py-6">
                                            <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${posteBadge.color}`}>
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="flex items-center justify-center gap-3">
                                            ...
                                            <button
                                                onClick={() => employee.employeId && hook.handleDelete(employee.employeId)}
