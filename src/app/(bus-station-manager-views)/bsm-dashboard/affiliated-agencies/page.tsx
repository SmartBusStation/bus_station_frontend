...
import AffiliatedAgenciesList from "@/components/bus-station-dashboard/AffiliatedAgenciesList";
import Loader from "@/modals/Loader";
import { AlertCircle, RefreshCw } from "lucide-react";

const AffiliatedAgenciesPage = () => {
  const { agencies, loading, error } = useBusStationDashboard("gare-001");
  ...
  return (
    <div className="space-y-8">
      <AffiliatedAgenciesList agencies={agencies} />
    </div>
  );
};

export default AffiliatedAgenciesPage;